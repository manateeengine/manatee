...
pub const Window = opaque {
    ...
    ///
    /// * Original: `HBRUSH``CreateWindowExW`
    ...
    ///
    /// * Original: `HBRUSH`DefWindowProcW
    ...
    ///
    /// * Original: `HBRUSH``PostQuitMessage'
...
///
/// * Original: `HBRUSH``DWORD dwExStyle`
