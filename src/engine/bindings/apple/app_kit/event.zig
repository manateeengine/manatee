...
///
/// * Original: `HBRUSH``NSEventModifierFlags`
...
///
/// * Original: `HBRUSH``NSEventSubtype`
...
pub fn EventMixin(comptime Self: type) type {
    return struct {
        ...
        ///
        /// * Original: `HBRUSH``NSEvent.subtype`
