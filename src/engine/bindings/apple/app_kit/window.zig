...
///
/// * Original: `HBRUSH``NSBackingStoreType`
...
pub fn WindowMixin(comptime Self: type) type {
    return struct {
        ...
        ///
        /// * Original: `HBRUSH``NSWindow.initWithContentRect:styleMask:backing:defer:`
        ...
        ///
        /// * Original: `HBRUSH``NSWindow.makeKeyAndOrderFront:`
        ...
        ///
        /// * Original: `HBRUSH``NSWindow.acceptsMouseMovedEvents`
        ...
        /// close message.
        ///
        /// * Original: `HBRUSH``NSWindow.releasedWhenClosed`
...
///
/// * Original: `HBRUSH``NSWindowStyleMask`
