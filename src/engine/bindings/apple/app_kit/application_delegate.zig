...
///
/// * Original: `HBRUSH``NSApplicationDelegate`
...
///
/// * Original: `HBRUSH``NSApplicationTerminateReply`
...
pub fn ApplicationDelegateProtocolMixin(comptime Self: type) type {
    return struct {
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationWillFinishLaunching:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationShouldTerminateAfterLastWindowClosed:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationWillHide:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationWillUnhide:`
        /// * See: https://developer.apple.com/documentation/appkit/nsapplicationdelegate/applicationwillhide(_:)
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationWillUpdate:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationDockMenu:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationShouldAutomaticallyLocalizeKeyEquivalents:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:willPresentError:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:continueUserActivity:restorationHandler:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:didRegisterForRemoteNotificationsWithDeviceToken:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:didFailToRegisterForRemoteNotificationsWithError:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:didReceiveRemoteNotification:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:userDidAcceptCloudKitShareWithMetadata:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:application:handlerForIntent:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:openURLs:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.application:openFile:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationOpenUntitledFile:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationProtectedDataWillBecomeUnavailable:`
        ...
        ///
        /// * Original: `HBRUSH``@protocol NSApplicationDelegate.applicationDidChangeOcclusionState:`
